...
class Past : Fragment() {
    ...
    private lateinit var pastArray: ArrayList<Edvora>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        pastArray = ArrayList<Edvora>()

        adapter = EdvoraAdapter(pastArray)
        pastRecyclerView = view.findViewById<RecyclerView>(R.id.pastRecyclerView)
    ...
    fun fetchRides() {
        ...
        val stringRequest = StringRequest(
            Request.Method.GET, rideUrl,
            {
                ...
                pastRecyclerView.adapter = adapter
            },
            {
